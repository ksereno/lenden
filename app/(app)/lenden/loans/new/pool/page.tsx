...
import { getBorrowers, getLoans, getAllPayments, getPoolDeposits, getPoolTransfers } from "@/lib/queries";
...
export default async function NewPoolLoanPage({
  ...
  const [borrowers, loans, allPayments, deposits, transfers] = await Promise.all([
    getBorrowers(),
    getLoans(),
    getAllPayments(),
    getPoolDeposits(),
