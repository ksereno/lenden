...
export default async function CashInFundingChoicePage() {
  ...
  return (
    <div className="flex max-w-lg flex-col gap-8">
      <div>
        ...
        <h1 className="text-xl font-semibold text-foreground">Cash In</h1>
        <p className="mt-1 text-sm text-muted">How is this transaction funded?</p>
      </div>

      <div className="flex flex-col gap-4">
        <Link
          href="/exchange/transactions/new/cash-in/pool"
        ...
        <Link
          href="/exchange/transactions/new/cash-in/individual"
          className="rounded-lg border border-border bg-surface p-5 hover:border-accent"
        >
